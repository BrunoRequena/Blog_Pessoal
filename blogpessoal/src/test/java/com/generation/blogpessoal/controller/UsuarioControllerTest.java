...
public class UsuarioControllerTest {
	...
	public void deveFazerLogin() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Juliana Andrews2", "juliana_andrews2@email.com.br",
				"juliana2123", "https://i.imgur.com/2yDRVeK7.jpg"));

		HttpEntity<UsuarioLogin> corpoDaRequisicao = new HttpEntity<UsuarioLogin>(
				new UsuarioLogin(0L, "", "juliana_andrews2@email.com.br", "juliana2123", ""));
